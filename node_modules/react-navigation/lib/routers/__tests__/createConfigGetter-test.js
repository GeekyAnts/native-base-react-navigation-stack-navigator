...
var babelPluginFlowReactPropTypes_proptype_NavigationScreenOptionsGetter = require('../../TypeDefinition').babelPluginFlowReactPropTypes_proptype_NavigationScreenOptionsGetter || require('react').PropTypes.any;
...
test('should get config for screen', function () {
  ...
  NotificationScreen.navigationOptions = function (_ref2) {
    ...
    return {
      title: '42',
      gesturesEnabled: navigation.state.params ? !navigation.state.params.fullscreen : true
    };
  };
  ...
  var routes = [{ key: 'A', routeName: 'Home' }, { key: 'B', routeName: 'Home', params: { user: 'jane' } }, { key: 'C', routeName: 'Settings' }, { key: 'D', routeName: 'Notifications' }, { key: 'E', routeName: 'Notifications', params: { fullscreen: true } }];

  expect(getScreenOptions((0, _addNavigationHelpers2.default)({ state: routes[0], dispatch: function dispatch() {
      return false;
    } }), {}).title).toEqual('Welcome anonymous');
  expect(getScreenOptions((0, _addNavigationHelpers2.default)({ state: routes[1], dispatch: function dispatch() {
      return false;
    } }), {}).title).toEqual('Welcome jane');
  expect(getScreenOptions((0, _addNavigationHelpers2.default)({ state: routes[0], dispatch: function dispatch() {
      return false;
    } }), {}).gesturesEnabled).toEqual(true);
  expect(getScreenOptions((0, _addNavigationHelpers2.default)({ state: routes[2], dispatch: function dispatch() {
      return false;
    } }), {}).title).toEqual('Settings!!!');
  expect(getScreenOptions((0, _addNavigationHelpers2.default)({ state: routes[2], dispatch: function dispatch() {
      return false;
    } }), {}).gesturesEnabled).toEqual(false);
  expect(getScreenOptions((0, _addNavigationHelpers2.default)({ state: routes[3], dispatch: function dispatch() {
      return false;
    } }), {}).title).toEqual('10 new notifications');
  expect(getScreenOptions((0, _addNavigationHelpers2.default)({ state: routes[3], dispatch: function dispatch() {
      return false;
    } }), {}).gesturesEnabled).toEqual(true);
  expect(getScreenOptions((0, _addNavigationHelpers2.default)({ state: routes[4], dispatch: function dispatch() {
      return false;
    } }), {}).gesturesEnabled).toEqual(false);
});
...
test('should throw if the route does not exist', function () {
  ...
  expect(function () {
    return getScreenOptions((0, _addNavigationHelpers2.default)({ state: routes[0], dispatch: function dispatch() {
        return false;
      } }), {});
