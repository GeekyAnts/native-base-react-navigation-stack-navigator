...
describe('StateUtils', function () {
  ...
  it('gets route index', function () {
    var state = {
      index: 1,
      routes: [{ key: 'a', routeName: routeName }, { key: 'b', routeName: routeName }]
    };
  ...
  it('does not push duplicated route', function () {
    var state = { index: 0, routes: [{ key: 'a', routeName: routeName }] };
    expect(function () {
      return _StateUtils2.default.push(state, { key: 'a', routeName: routeName });
    }).toThrow();
  });
  ...
  it('Replaces by key', function () {
    ...
    var newState = {
      index: 1,
      routes: [{ key: 'a', routeName: routeName }, { key: 'c', routeName: routeName }]
    };
    expect(_StateUtils2.default.replaceAt(state, 'b', { key: 'c', routeName: routeName })).toEqual(newState);
  });
  ...
  it('Replaces by index', function () {
    ...
    expect(_StateUtils2.default.replaceAtIndex(state, 1, { key: 'c', routeName: routeName })).toEqual(newState);
  });
  ...
  it('Returns the state if index matches the route', function () {
    ...
    expect(_StateUtils2.default.replaceAtIndex(state, 1, state.routes[1])).toEqual(state);
  });
  ...
  it('Resets routes', function () {
    ...
    var newState = {
      index: 1,
      routes: [{ key: 'x', routeName: routeName }, { key: 'y', routeName: routeName }]
    };
    expect(_StateUtils2.default.reset(state, [{ key: 'x', routeName: routeName }, { key: 'y', routeName: routeName }])).toEqual(newState);
  ...
  it('Resets routes with index', function () {
    ...
    expect(_StateUtils2.default.reset(state, [{ key: 'x', routeName: routeName }, { key: 'y', routeName: routeName }], 0)).toEqual(newState);
