...
class Header extends React.PureComponent {
  ...
  _renderLeftComponent = props => {
    ...
    }} pressColorAndroid={options.headerPressColorAndroid} tintColor={options.headerTintColor} title={backButtonTitle} truncatedTitle={truncatedBackButtonTitle} width={width} />;
  };
  ...
  render() {
    ...
    return <Animated.View {...rest} style={[styles.container, style]}>
