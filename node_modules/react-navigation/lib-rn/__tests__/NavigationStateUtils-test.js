...
describe('StateUtils', () => {
  ...
  it('Replaces by key', () => {
    ...
    expect(NavigationStateUtils.replaceAt(state, 'b', { key: 'c', routeName })).toEqual(newState);
  });
  ...
  it('Replaces by index', () => {
    ...
    expect(NavigationStateUtils.replaceAtIndex(state, 1, { key: 'c', routeName })).toEqual(newState);
  });
  ...
  it('Returns the state if index matches the route', () => {
    ...
    expect(NavigationStateUtils.replaceAtIndex(state, 1, state.routes[1])).toEqual(state);
  });
  ...
  it('Resets routes', () => {
    ...
    expect(NavigationStateUtils.reset(state, [{ key: 'x', routeName }, { key: 'y', routeName }])).toEqual(newState);
  ...
  it('Resets routes with index', () => {
    ...
    expect(NavigationStateUtils.reset(state, [{ key: 'x', routeName }, { key: 'y', routeName }], 0)).toEqual(newState);
